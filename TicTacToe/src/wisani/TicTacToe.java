...
/**
 *
 * @author Mahumane_Wisani_W
 */
public class TicTacToe extends javax.swing.JFrame {

    private String startGame = "X"; //Starting variable-symbol of the tic tac
    private int xCount = 0, oCount = 0; //I need to count and show how many times a certain player won
    ...
    public TicTacToe() {
        initComponents();
        setSize(1200, 600); //set my screen size 
        setLocationRelativeTo(null); //make screen location to 
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Wisani`s Tic Tac Toe");
        ...
        lblPlayerX.setFont(new java.awt.Font("Yu Gothic UI Semibold", 3, 48)); // NOI18N
        ...
        lblPlayerO.setFont(new java.awt.Font("Yu Gothic UI Semibold", 3, 48)); // NOI18N
        lblPlayerO.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jPanel12.add(lblPlayerO, java.awt.BorderLayout.CENTER);
    ...
    private void winGame() {
        //First button combination
        String b1 = jButton1.getText();
        String b2 = jButton2.getText();
        String b3 = jButton3.getText();

        //Second button combination
        String b4 = jButton4.getText();
        String b5 = jButton5.getText();
        String b6 = jButton6.getText();

        //Third button combination
    ...
    private void btnExitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExitActionPerformed
        ...
        if (JOptionPane.showConfirmDialog(frame, "Do you want to Exit Tic Tac Toe? ", "Tic Tac Toe",
