...
public class SimpleCalc implements ActionListener{
      ...
      public SimpleCalc()
    {
        ...
        objFrame.setTitle("Simple Calculator");
        objFrame.setSize(300,300);
        //This will center the JFrame in the middle of the screen
        objFrame.setLocationRelativeTo(null);
        
        numberCalc = new JTextField("0");
        numberCalc.setHorizontalAlignment(JTextField.RIGHT);
        numberCalc.setEditable(false);        
        objFrame.add(numberCalc, BorderLayout.NORTH);
        
        buttonPanel = new JPanel();
               
        //Make a Grid that has three rows and four columns
        buttonPanel.setLayout(new GridLayout(4,4));   
        objFrame.add(buttonPanel, BorderLayout.CENTER);
        ...
        multiplyButton.addActionListener(divAction);
        
        
          JButton divideButton = new JButton("/");
           divideButton.setActionCommand("/");
     
           OperatorAction multiAction = new OperatorAction(4);
        divideButton.addActionListener(multiAction);
